				...
				if (nnm != null) {
					for (int y = 0; y < nnm.getLength(); y++) {
						...
						if (nodeType == Type.LINE) {
							...
							case "x1":
								line.setX1(Double.parseDouble(nnm.item(y).getNodeValue()) * Main.DrawFactor);
								break;
							case "x2":
								line.setX2(Double.parseDouble(nnm.item(y).getNodeValue()) * Main.DrawFactor);
								break;
							case "y1":
								line.setY1(Double.parseDouble(nnm.item(y).getNodeValue()) * Main.DrawFactor);
								break;
							case "y2":
								line.setY2(Double.parseDouble(nnm.item(y).getNodeValue()) * Main.DrawFactor);
								break;
							}
						} else if (nodeType == Type.RECT) {
							switch (nnm.item(y).getNodeName()) {
							case "x":
								rect.setX(Double.parseDouble(nnm.item(y).getNodeValue()) * Main.DrawFactor);
								break;
							case "y":
								rect.setY(Double.parseDouble(nnm.item(y).getNodeValue()) * Main.DrawFactor);
								break;
							case "height":
								rect.setHeight(Double.parseDouble(nnm.item(y).getNodeValue()) * Main.DrawFactor);
								break;
							case "width":
								rect.setWidth(Double.parseDouble(nnm.item(y).getNodeValue()) * Main.DrawFactor);
								break;
							}
						}
					}
